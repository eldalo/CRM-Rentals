...
/**
 * Scoping de asesores. Un asesor solo ve/gestiona los apartamentos de los que
 * es responsable (apartamentos.responsable_id) y sus pagos. super_admin y
 * admin no se filtran (ven todo).
 *
